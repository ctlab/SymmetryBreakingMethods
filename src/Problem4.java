...
public class Problem4 {
    public static final int[] f4 = {0, 0, 1, 3, 5, 6, 7, 9, 11, 13, 16, 18, 21, 24, 27, 30, 33, 36, 
            39, 42, 46, 50, 52, 56, 59, 63, 67, 71, 76, 80, 85, 90};
    ...
    private void declareDegrees(PrintWriter out) {
        ...
        // Declare minimum, maximum degrees  
